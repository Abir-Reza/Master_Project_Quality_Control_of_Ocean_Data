...
diss_features = ['t','depth','eps1','acc','sinkvel','spikeflag1']
...
def create_test_train_data():
    ...
    print('Augmented Data shape',augmented_train.shape)
