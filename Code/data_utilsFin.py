...
def process_train_data(num_signals,seq_length,seq_step, augment = None):
    if augment:
        train = np.load('/home/students/MAD-GAN/Master_Project_Quality_Control_of_Ocean_Data/Code/settings/data/contaminated_train.npy',allow_pickle=True)
    else:
        train = np.load('/home/students/MAD-GAN/Master_Project_Quality_Control_of_Ocean_Data/Code/settings/data/kdd99_train.npy',allow_pickle=True)
...
def process_test_data(num_signals,seq_length,seq_step):
    test = np.load('/home/students/MAD-GAN/Master_Project_Quality_Control_of_Ocean_Data/Code/settings/data/kdd99_test.npy',allow_pickle=True)
    ...
    np.save('/home/students/MAD-GAN/Master_Project_Quality_Control_of_Ocean_Data/Code/settings/data/' + str(len(labels)), labels)
